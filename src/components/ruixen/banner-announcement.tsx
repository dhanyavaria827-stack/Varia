      ...
      <div className="overflow-hidden">
        <div
          className={cn(
            ...
            "before:bg-[linear-gradient(110deg,transparent_30%,color-mix(in_oklch,var(--foreground)_4%,transparent)_44%,color-mix(in_oklch,var(--foreground)_8%,transparent)_50%,color-mix(in_oklch,var(--foreground)_4%,transparent)_56%,transparent_70%)]",
