...
function avatarDataUri(hue: number, initial: string) {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"><rect width="56" height="56" rx="28" fill="hsl(${hue} 45% 82%)" /><text x="28" y="37" font-family="ui-sans-serif,system-ui" font-size="22" fill="hsl(${hue} 35% 40%)" text-anchor="middle">${initial}</text></svg>`;
