  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "bg-parchment/85 backdrop-blur-md shadow-[0_12px_28px_-20px_rgba(44,40,37,0.35)]"
          : "bg-transparent"
      )}
    >
              ...
              >
                {active && (
                  <motion.span
                    ...
                    className="absolute -bottom-1 left-1/2 h-2 w-2 -translate-x-1/2 rounded-full bg-brass-500 shadow-[0_0_14px_4px_rgba(111,42,46,0.55)]"
                  />
                )}
