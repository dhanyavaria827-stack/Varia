// lucide-react dropped brand/trademarked icons, so this is the WhatsApp glyph
// drawn as a filled path — the speech bubble with the handset inside, which is
// what people actually recognise. Used instead of a generic phone or
// message-bubble icon anywhere the number behind it is a WhatsApp number.
