            ...
            <Magnetic strength={12} className="mt-8 inline-block">
              <PremiumCTA>
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-sm bg-brass-500 px-7 py-3.5 text-sm font-medium uppercase tracking-[0.06em] text-camel-50 shadow-soft transition hover:bg-camel-600 active:scale-95"
                >
                  See how to help
                  <ArrowRight size={16} />
                </Link>
